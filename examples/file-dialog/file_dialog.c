...
int main(int argc, char** argv) {
        ...
        NvdFileDialog* dialog = nvd_open_file_dialog_new("Open File",
                                                         filters);
        /* We will also display a dialog for selecting a folder instead of a dialog. */
        NvdFileDialog *dir_dialog = nvd_open_folder_dialog_new("Open folder...", NULL);
        ...
        if (directory != NULL) printf("Chosen directory: %s\n", directory);
        else printf("No directory selected.\n");
